const CACHE='daily-life-shell-v33';
const SHELL=['./','./index.html','./public.html','./privacy.html','./terms.html','./delete-account.html','./reset-password.html','./assets/styles.css?v=20260923-square-v2','./assets/favicon.svg','./js/config.js?v=20260918-community-inserts-v1','./js/drafts.js?v=20260918-community-inserts-v1','./js/db.js?v=20260923-square-v2','./js/storage.js?v=20260921-upload-recovery-v1','./js/telemetry.js?v=20260920-error-logs-v1','./js/app.js?v=20260926-comment-count-v1','./js/project-files-ui.js?v=20260918-community-inserts-v1','./js/public.js','./js/delete-account.js','./js/reset-password.js?v=20260919-password-recovery-v1','./manifest.webmanifest'];
